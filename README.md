...
сеть умеренного острова 96×96 из 20 видов (трава/деревья/кустарники,
травоядные/всеядные/хищники, опылители и редуценты). Виды описаны данными,
сценарий воспроизводится по seed. Визуализатор показывает сам остров через Terrain3D (клипмап из снимка
`HabitatGrid`), время суток, сводку намерений и пакетно рисует организмы.
