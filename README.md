...
сеть умеренного острова 256×256 по 75 м на клетку (19,2 км по стороне) из 20 видов
(трава/деревья/кустарники, травоядные/всеядные/хищники, опылители и редуценты).
Виды описаны данными, сценарий воспроизводится по seed. 3D-визуализатор получает только
